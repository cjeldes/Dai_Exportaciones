...
class Producto {
    ...
    function Agrega() {
        ...
        /* Definici�n del query que permitira eliminar un registro */
        $sqladd = "INSERT INTO PRODUCTOS(NOMBRE,TOTALUSD,ANO) VALUES(:nombre,:valor,:anio);";
        

        /* Preparaci�n SQL */
        $queryadd = $db->prepare($sqldel);

        $queryadd->bindParam(':nombre', $this->$snombre);
        $queryadd->bindParam(':valor', $this->$ntotalusd);
